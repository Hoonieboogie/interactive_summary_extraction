                ...
                Sa = function(d, g) {
                    ...
                    var h, i, j, k, l, r, u, v, x, D, G, K, O, R, T, U, Y, aa, ca, da, ea, fa, ga, ka, la, ma, na, oa, pa, qa, ra, sa, ta = (g.type || (B ? "top,left" : "x,y")).toLowerCase(),
                        ...
                        ab = function(a) {
                            ...
                            ka = Aa(d.parentNode, !0), a && Da.isPressed && n.join(",") !== ka.join(",") && (b = n[0], c = n[1], e = n[2], f = n[3], g = n[4], h = n[5], i = b * f - c * e, l = j * (f / i) + k * (-e / i) + (e * h - f * g) / i, m = j * (-c / i) + k * (b / i) + -(b * h - c * g) / i, k = l * ka[1] + m * ka[3] + ka[5], j = l * ka[0] + m * ka[2] + ka[4]), ka[1] || ka[2] || 1 != ka[0] || 1 != ka[3] || 0 != ka[4] || 0 != ka[5] || (ka = null)
                        },
                        bb = function() {
                            var a = 1 - Da.edgeResistance;
                            ab(!1), ka && (j = Da.pointerX * ka[0] + Da.pointerY * ka[2] + ka[4], k = Da.pointerX * ka[1] + Da.pointerY * ka[3] + ka[5]), aa && (hb(Da.pointerX, Da.pointerY), Va(!0)), i ? (Ya(), r = i.top(), l = i.left()) : (cb() ? (Xa(!0, !0), Ya()) : Da.applyBounds(), va ? (Y = Ba(d, {
                                x: 0,
                                y: 0
                        ...
                        db = function() {
                            !C.parentNode || cb() || Da.isDragging || C.parentNode.removeChild(C)
                        },
                        eb = function(a, b, c, d) {
                        ...
                        fb = function(a) {
                            ...
                            if (!(!h || Da.isPressed || !a || ("mousedown" === a.type || "pointerdown" === a.type) && A() - Ua < 30 && Ha[Da.pointerEvent.type])) {
                                if (la = cb(), Da.pointerEvent = a, Ha[a.type] ? (ga = -1 !== a.type.indexOf("touch") ? a.currentTarget || a.target : s, Ia(ga, "touchend", ib), Ia(ga, "touchmove", gb), Ia(ga, "touchcancel", ib), Ia(s, "touchstart", Ma)) : (ga = null, Ia(s, "mousemove", gb)), qa = null, Ia(s, "mouseup", ib), a && a.target && Ia(a.target, "mouseup", ib), fa = Ta.call(Da, a.target) && !g.dragClickables) return Ia(a.target, "change", ib), ia(Da, "press", "onPress"), void Pa(Ea, !0);
                                if (pa = !ga || ya === za || i || Da.vars.allowNativeTouchScrolling === !1 ? !1 : ya ? "y" : "x", B ? a = $(a, !0) : pa || Da.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = T = a.changedTouches[0], U = a.identifier) : a.pointerId ? U = a.pointerId : T = U = null, H++, P(Va), k = Da.pointerY = a.pageY, j = Da.pointerX = a.pageX, (pa || Da.autoScroll) && Z(d.parentNode), d.parentNode && (i || Da.autoScroll && !va && d.parentNode._gsMaxScrollX && !C.parentNode) && !d.getBBox && (C.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(C)), bb(), Da.tween && Da.tween.kill(), Da.isThrowing = !1, b.killTweensOf(i || d, !0, Fa), i && b.killTweensOf(d, !0, {
                                        scrollTo: 1
                        ...
                        gb = function(a) {
                            ...
                            if (h && !e && Da.isPressed && a) {
                                ...
                                if (B) a = $(a, !0);
                                    ...
                                    if (ga && pa && !qa && (c = a.pageX, d = a.pageY, ka && (f = c * ka[0] + d * ka[2] + ka[4], d = c * ka[1] + d * ka[3] + ka[5], c = f), qa = Math.abs(c - j) > Math.abs(d - k) && ya ? "x" : "y", Da.vars.lockAxisOnTouchScroll !== !1 && (Da.lockedAxis = "x" === qa ? "y" : "x", "function" == typeof Da.vars.onLockAxis && Da.vars.onLockAxis.call(Da, g)), I && pa === qa)) return void ib(g);
                                    Da.allowEventDefault || pa && (!qa || pa === qa) || g.cancelable === !1 || (g.preventDefault(), g.preventManipulation && g.preventManipulation())
                                }
                                Da.autoScroll && (Qa = !0), hb(a.pageX, a.pageY)
                            }
                        },
                        hb = function(a, b) {
                        ...
                        ib = function(a, c) {
                            if (h && Da.isPressed && (!a || null == U || c || !(a.pointerId && a.pointerId !== U || a.changedTouches && !Ka(a.changedTouches, U)))) {
                                ...
                                var e, f, i, j, k, l = a,
                                    m = Da.isDragging,
                                    n = b.delayedCall(.001, db);
                                if (ga ? (Ja(ga, "touchend", ib), Ja(ga, "touchmove", gb), Ja(ga, "touchcancel", ib), Ja(s, "touchstart", Ma)) : Ja(s, "mousemove", gb), Ja(s, "mouseup", ib), a && a.target && Ja(a.target, "mouseup", ib), aa = !1, fa) return a && Ja(a.target, "change", ib), Pa(Ea, !1), ia(Da, "release", "onRelease"), ia(Da, "click", "onClick"), void(fa = !1);
                                if (Q(Va), !va)
                                    for (f = Ea.length; --f > -1;) ba(Ea[f], "cursor", g.cursor || "move");
                                if (m && (La = J = A(), Da.isDragging = !1), H--, a) {
                                    if (B && (a = $(a, !1)), e = a.changedTouches, e && (a = e[0], a !== T && a.identifier !== U)) {
                                        for (f = e.length; --f > -1 && (a = e[f]).identifier !== U;);
                                        if (0 > f) return
                                    }
                                    Da.pointerEvent = l, Da.pointerX = a.pageX, Da.pointerY = a.pageY
                                }
                                return l && !m ? (la && (g.snap || g.bounds) && _a(g.throwProps), ia(Da, "release", "onRelease"), I && "touchmove" === l.type || (ia(Da, "click", "onClick"), j = l.target || l.srcElement || d, Ua = A(), k = function() {
                                ...
                                }, k(), b.delayedCall(1e-5, k))) : (_a(g.throwProps), B || Da.allowEventDefault || !l || !g.dragClickables && Ta.call(Da, l.target) || !m || pa && (!qa || pa !== qa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation()), ia(Da, "release", "onRelease")), cb() && n.duration(Da.tween.duration()), m && ia(Da, "dragend", "onDragEnd"), !0
                            }
                        },
                        jb = function(a) {
                            if (a && Da.isDragging) {
                                ...
                                (c || e) && (ka ? (j -= c * ka[0] + e * ka[2], k -= e * ka[3] + c * ka[1]) : (j -= c, k -= e), b._gsScrollX += c, b._gsScrollY += e, hb(Da.pointerX, Da.pointerY))
                            }
                        },
                        kb = function(a) {
                            var b = A(),
                    ...
                    ca = Sa.get(this.target), ca && ca.kill(), this.startDrag = function(a) {
                        fb(a), Da.isDragging || (Da.isDragging = !0, ia(Da, "dragstart", "onDragStart"))
                    }, this.drag = gb, this.endDrag = function(a) {
                        ib(a, !0)
                        ...
                        var e = Da.x,
                            f = Da.y;
                        return ab(!b), a ? Da.applyBounds() : (aa && c && Va(!0), Xa(!0)), b && (hb(Da.pointerX, Da.pointerY), aa && Va(!0)), Da.isPressed && !b && (ya && Math.abs(e - Da.x) > .01 || za && Math.abs(f - Da.y) > .01 && !va) && bb(), Da.autoScroll && (Z(d.parentNode), Qa = Da.isDragging, Va(!0)), Da.autoScroll && (W(d, jb), V(d, jb)), Da
                    }, this.enable = function(a) {
                        var e, j, k;
                        if ("soft" !== a) {
                            for (j = Ea.length; --j > -1;) k = Ea[j], Ia(k, "mousedown", fb), Ia(k, "touchstart", fb), Ia(k, "click", kb, !0), va || ba(k, "cursor", g.cursor || "move"), ba(k, "touchCallout", "none"), ba(k, "touchAction", ya === za || i ? "none" : ya ? "pan-y" : "pan-x");
                            Pa(Ea, !1)
                        }
                        return V(d, jb), h = !0, f && "soft" !== a && f.track(i || d, ua ? "x,y" : va ? "rotation" : "top,left"), i && i.enable(), d._gsDragID = e = "d" + F++, E[e] = this, i && (i.element._gsDragID = e), b.set(d, {
                            x: "+=0",
                            overwrite: !1
                        }), oa = {
                            t: d,
                        ...
                        if ("soft" !== a) {
                            for (b = Ea.length; --b > -1;) c = Ea[b], ba(c, "touchCallout", null), ba(c, "touchAction", null), Ja(c, "mousedown", fb), Ja(c, "touchstart", fb), Ja(c, "click", kb);
                            Pa(Ea, !0), ga && (Ja(ga, "touchcancel", ib), Ja(ga, "touchend", ib), Ja(ga, "touchmove", gb)),
                                Ja(s, "mouseup", ib), Ja(s, "mousemove", gb)
                        }
                        return W(d, jb), h = !1, f && "soft" !== a && f.untrack(i || d, ua ? "x,y" : va ? "rotation" : "top,left"), i && i.disable(), Q(Va), Da.isDragging = Da.isPressed = fa = !1, e && ia(Da, "dragend", "onDragEnd"), Da
