...
- **P2** is the most impactful — it's the only prompt that sees raw content. If it misclassifies or produces poor summaries, everything downstream suffers.
- **P5** (or P7 in overflow case) directly produces the final deliverable. Quality criteria here directly affect output quality.
- **P1, P3, P4, P6** are supporting prompts — they affect robustness but have less direct impact on final output quality.
